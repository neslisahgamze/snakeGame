...
#Colours
red = pygame.Colour(255, 0, 0)  #gameover
green = pygame.Colour(0, 255, 0) #snake
black = pygame.Colour(0, 0, 0) #score
white = pygame.Colour(255, 255, 255) #background
brown = pygame.Colour(165, 42, 42) #food
